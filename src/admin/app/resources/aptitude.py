...
async def grade_aptitude(
    ...
    *,
    ...
    # Answers are positional in *served* order; map each back to its original question.
    # Each must index a real option (candidate input): reject out-of-range, don't
    # silently score it wrong.
