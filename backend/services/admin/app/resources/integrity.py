...
log = get_logger(component="integrity.resources")
...
async def get_integrity_timeline(
    ...
    *,
    ...
    async with log_context(
        log,
        "resource.integrity.get_integrity_timeline",
        **bind_ids(comp_id=identity["comp_id"], application_id=application_id),
    ):
        ...
        # recording_key carries the tenant prefix; presigned verbatim — tenant authz
        # already happened above (comp_id match). Empty until LiveKit egress lands
        # the key — C1.
