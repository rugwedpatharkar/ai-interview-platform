...
import { FlagSeverity, HIGH_SIGNALS } from "./types";
...
export function makeMockIntegrityClient() {
  return async (applicationId: string): Promise<IntegrityTimeline> => {
    const flags: ProctorFlag[] = [
      { type: "tab_hidden", severity: FlagSeverity.LOW, at: "2026-06-20T10:01:04Z", meta: {} },
      { type: "gaze_off_screen", severity: FlagSeverity.LOW, at: "2026-06-20T10:03:22Z", meta: {} },
      { type: "camera_occluded", severity: FlagSeverity.MED, at: "2026-06-20T10:06:10Z", meta: {} },
      { type: "second_face", severity: FlagSeverity.HIGH, at: "2026-06-20T10:08:41Z", meta: { faces: "2" } },
    ];
