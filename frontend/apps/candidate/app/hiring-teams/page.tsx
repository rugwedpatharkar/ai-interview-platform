...
// (hero + InterviewHud, stats, evidence-flip, how-it-happens, platform bento,
// integrity timeline, defense split, evidence report, advisory gate, compare
// table, what-you-get, trust, designed-for, early-access, FAQ, final CTA) is
// folded in verbatim and re-skinned in Lucent glass. Token-driven .ap-* widgets
// (ap-ring, ap-bar, ap-itl-*, ap-compare-*, ap-cell-*, ap-defense) are reused
// as-is — they render on-brand inside the glass sections. Light-only.

// ── Brand mark (spins the aperture blades) ───────────────────────────────────
        ...
        <div className="wrap">
          <div className="foot">
            ...
            <div className="foot-right">
              <span>Hire on proven merit. Cheat-proof by design.</span>
              <span>© Aptura</span>
            </div>
          </div>
        </div>
