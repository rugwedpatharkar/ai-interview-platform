...
// @ip/shared — the company twin of the candidate view. Resolves the company messages client,
// runs the hook, and feeds the view its recruiter copy/icon/bubble deltas. For a recruiter,
// the other side is the candidate.
...
export function MessageThreadView({
  ...
  return (
    <SharedMessageThreadView
      ...
      peerIcon={UserRound}
      emptyDescription="Start the conversation below — the candidate will see your reply."
